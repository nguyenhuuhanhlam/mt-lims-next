...
def user_tasks(request):
    tests = MaterialTest.objects.filter(tester=request.user).select_related("request", "method_uploader", "result_uploader").order_by("-created_at")
    ...
    return render(request, "material_tests/user_tasks.html", {"tests": tests, "q": q, "status_filter": status_filter, "filter_options": filter_options})
